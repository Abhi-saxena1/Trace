...
|---|---|---:|---:|---|---|---:|---:|---:|
| PlayerZero | PlayerZero | 2026-03 | 1 | X | X date only | 1 | 0 | 0 |
| Wispr Flow | Wispr Flow | 2026-02 | 2 | X, LinkedIn | X date only; LinkedIn unavailable | 1 | 0 | 0 |
| Poly AI | unavailable | 2026-02 | 1 | X | X date only | 1 | 0 | 0 |
| Airwallex | unavailable | 2025-12 | 2 | X, LinkedIn | X date only; LinkedIn unavailable | 2 | 0 | 0 |
| Gamma | Gamma | 2025-11 | 2 | X, LinkedIn | X date only; LinkedIn unavailable | 2 | 0 | 0 |
| Cartesia | Sonic-3 | 2025-10 | 2 | X, LinkedIn | X date only; LinkedIn unavailable | 2 | 0 | 0 |
| Deel | unavailable | 2025-10 | 2 | X, LinkedIn | X date only; LinkedIn unavailable | 2 | 0 | 0 |
| Superblocks | Clark | 2025-05 | 1 | X | X date only | 1 | 0 | 0 |
| Icon | Icon | 2025-02 | 2 | X, LinkedIn | X date only; LinkedIn unavailable | 2 | 0 | 0 |
...
Each of the nine conservative launch events has one normalized mechanics record connecting its campaign, content, platform, timestamp state and source. Platform order and time deltas are unknown for the reviewed corpus: X values are day precision and paired LinkedIn timestamps are unavailable. The model calculates X-first, LinkedIn-first, or a 15-minute same-window classification only for precise paired timestamps.
...
No visual transformation, creator-network coordination, referral mechanics, performance effect, precise launch-day sequence, or recurring timing window can be established from the loaded records.
