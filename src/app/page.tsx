...
export default async function Home() {
  ...
  return <>
    <section className="hero">
      <div className="hero-kicker eyebrow"><span className="status-dot" />Independent research</div>
